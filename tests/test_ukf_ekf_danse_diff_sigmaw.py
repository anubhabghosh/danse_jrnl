...
def test_lorenz(device='cpu', model_file_saved=None, model_file_saved_mismatched=None,  model_file_saved_knet=None, model_file_saved_knet_mismatched=None, test_data_file=None, test_logfile=None, evaluation_mode='Full', p=0.5, bias=30):
    ...
    nmse_danse_mismatched = nmse_loss(X[:,0:,:], X_estimated_mismatched_filtered[:,0:,:])
    nmse_danse_mismatched_std = nmse_loss_std(X[:,0:,:], X_estimated_mismatched_filtered[:,0:,:])
    nmse_danse_pred = nmse_loss(X[:,0:,:], X_estimated_pred[:,0:,:])
    nmse_danse_pred_std = nmse_loss_std(X[:,0:,:], X_estimated_pred[:,0:,:])
    nmse_knet = nmse_loss(X[:,0:,:], X_estimated_filtered_knet[:,0:,:])
    nmse_knet_std = nmse_loss_std(X[:,0:,:], X_estimated_filtered_knet[:,0:,:])
    nmse_knet_mismatched = nmse_loss(X[:,0:,:], X_estimated_filtered_mismatched_knet[:,0:,:])
    nmse_knet_mismatched_std = nmse_loss_std(X[:,0:,:], X_estimated_filtered_mismatched_knet[:,0:,:])
    ...
    mse_dB_danse_mismatched = mse_loss_dB(X[:,0:,:], X_estimated_mismatched_filtered[:,0:,:])
    mse_dB_danse_mismatched_std = mse_loss_dB_std(X[:,0:,:], X_estimated_mismatched_filtered[:,0:,:])
    mse_dB_danse_pred = mse_loss_dB(X[:,0:,:], X_estimated_pred[:,0:,:])
    mse_dB_danse_pred_std = mse_loss_dB_std(X[:,0:,:], X_estimated_pred[:,0:,:])
    mse_dB_knet = mse_loss_dB(X[:,0:,:], X_estimated_filtered_knet[:,0:,:])
    mse_dB_knet_std = mse_loss_dB_std(X[:,0:,:], X_estimated_filtered_knet[:,0:,:])
    mse_dB_knet_mismatched = mse_loss_dB(X[:,0:,:], X_estimated_filtered_mismatched_knet[:,0:,:])
    mse_dB_knet_mismatched_std = mse_loss_dB_std(X[:,0:,:], X_estimated_filtered_mismatched_knet[:,0:,:])
